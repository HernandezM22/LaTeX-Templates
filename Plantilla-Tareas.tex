...
\newcommand{\myname}{Mauricio Hernández López}
\newcommand{\myemail}{A01173961}
\newcommand{\myhwtype}{Tarea}
\newcommand{\myhwnum}{1}
\newcommand{\myclass}{MA1036}
\newcommand{\mylecture}{Fundamentación del Álgebra Lineal}
...
\renewcommand{\questiontype}{Ejercicio}
\begin{numedquestion}
